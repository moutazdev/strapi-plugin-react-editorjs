...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-CXXF0Aeu.mjs";
...
function ReactEditorJS(_a) {
  ...
  const memoizedHolder = React__default.useRef(holder !== null && holder !== void 0 ? holder : `react-editor-js-${Date.now().toString(16)}`);
  const editorJS = React__default.useRef(null);
  ...
  return children || React__default.createElement("div", { id: memoizedHolder.current });
}
...
function ReactEditorJSClient(props) {
  const factory = React__default.useCallback((config) => new ClientEditorCore(config), []);
  return React__default.createElement(ReactEditorJS, Object.assign({ factory }, props));
}
console.log("🚀 ~ EditorJs:", ReactEditorJSClient);
...
const Editor = ({ onChange, name, value }) => {
  ...
  const editorCore = React__default.useRef(null);
  const imageSelectCbRef = React__default.useRef(null);
  const handleInitialize = React__default.useCallback((instance) => {
...
const Wysiwyg = ({
  ...
  return /* @__PURE__ */ React__default.createElement(
    ...
    {
      size: 1,
      className: `${cn(!lodashExports.isEmpty(className) && className)}`,
      style
    },
    /* @__PURE__ */ React__default.createElement(Box, null, /* @__PURE__ */ React__default.createElement(Typography, { variant: "pi", fontWeight: "bold" }, label), required && /* @__PURE__ */ React__default.createElement(Typography, { variant: "pi", fontWeight: "bold", textColor: "danger600" }, "*")),
    /* @__PURE__ */ React__default.createElement(
      Editor,
      {
        onChange,
    ...
    error && /* @__PURE__ */ React__default.createElement(Typography, { variant: "pi", textColor: "danger600" }, formatMessage({ id: error, defaultMessage: error })),
    description && /* @__PURE__ */ React__default.createElement(Typography, { variant: "pi" }, formatMessage(description))
  );
};
export {
  Wysiwyg as default
};
//# sourceMappingURL=index-kYQBs7yF.mjs.map
